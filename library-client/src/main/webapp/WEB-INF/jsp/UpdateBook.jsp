    ...
    <div class="row" style="margin-top: 40px">
        ...
        <div class="col-md-8">
            <div class="card" style="padding: 20px 30px">
                <div style="text-align: center; margin-top: 0px; margin-bottom: 20px"><h2>Edit Book</h2></div>
                <form class="form-group" action="/updateBook">
                    <input id="id" name="id" type="hidden" value="${Book.id}"/>
                    <label for="name">ISBN</label>
                    <input class="form-control" type="text" name="isbn" value="${Book.isbn}"><br>
                    ...
                    <input class="form-control" type="text" name="count" value="${Book.count}"><br>
                    <div class="row">
                        <div class="col-md-8">
                            <button class="btn btn-success" type="submit" style="width:100%">Save Book</button>
                        </div>
